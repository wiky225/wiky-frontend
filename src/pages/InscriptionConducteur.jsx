              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    <input type={showPassword ? 'text' : 'password'} name="password" value={formData.password} required onChange={handleChange}
                      className="input pr-10" placeholder="Min. 6 caractères" />
                ...
                <div>
                  ...
                  <div className="relative">
                    <input type={showConfirm ? 'text' : 'password'} name="password_confirm" value={formData.password_confirm} required onChange={handleChange}
                      className="input pr-10" placeholder="Répéter le mot de passe" />
