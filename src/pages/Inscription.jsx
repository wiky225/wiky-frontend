  ...
  return (
    <div className="min-h-screen bg-wikya-gray-light flex items-center justify-center py-12">
      <div className="container-custom max-w-3xl">
        <h1 className="text-3xl font-bold text-wikya-blue text-center mb-3">Créer un compte</h1>
        <p className="text-wikya-gray text-center mb-10">Choisissez votre profil pour commencer</p>

        <div className="grid md:grid-cols-2 gap-6">
          {/* Conducteur */}
          <div className="card p-8 flex flex-col items-center text-center hover:shadow-lg transition-shadow">
            <div className="text-6xl mb-4">🚗</div>
            <h2 className="text-2xl font-bold text-wikya-blue mb-3">Je suis Conducteur</h2>
            <p className="text-wikya-gray mb-6">
              Créez votre profil VTC et soyez visible auprès des recruteurs de toute la Côte d'Ivoire.
            </p>
            <ul className="text-sm text-wikya-gray text-left space-y-2 mb-8 w-full">
          ...
          <div className="card p-8 flex flex-col items-center text-center hover:shadow-lg transition-shadow">
            <div className="text-6xl mb-4">🏢</div>
            <h2 className="text-2xl font-bold text-wikya-blue mb-3">Je suis Recruteur</h2>
            <p className="text-wikya-gray mb-6">
        ...
        <p className="text-center text-sm text-wikya-gray mt-8">
          Déjà un compte ?{' '}
          <Link to="/connexion" className="text-wikya-blue hover:text-wikya-orange font-semibold">
            Connectez-vous
          </Link>
        </p>
      </div>
