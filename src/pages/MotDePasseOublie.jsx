    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
        <div className="bg-white rounded-2xl shadow-sm p-10 max-w-md w-full text-center">
          ...
          <h1 className="text-xl font-bold text-wiky-blue mb-2">Email envoyé !</h1>
          <p className="text-gray-500 mb-6">
            Un lien de réinitialisation a été envoyé à <strong>{email}</strong>.<br />
            Vérifiez votre boîte mail (et vos spams).
          </p>
          <Link to="/connexion" className="text-sm text-wiky-blue hover:underline">
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <div className="bg-white rounded-2xl shadow-sm p-8 max-w-md w-full">
        <h1 className="text-2xl font-bold text-wiky-blue mb-1">Mot de passe oublié</h1>
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          <Link to="/connexion" className="text-wiky-blue hover:underline">
            ← Retour à la connexion
          </Link>
        </p>
      </div>
